                ...
                <div class="our-benefits ">
                    <div class="row">
                        ...
                        <div class="col-4 col-md-4 text-center">
                            <a href="">
                                <div class="benefit-detail boderless d-flex flex-column align-items-center"><img class="benefit-img" src="assets/images/icons/Categories.png" alt="">
                                    <h5 class="benefit-title">Categories</h5>
                                </div>
                            </a>
                        </div>
                        <div class="col-4 col-md-3 text-center">
