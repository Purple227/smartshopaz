      ...
      <div class="ogami-breadcrumb">
        <div class="container">
          <ul>
            ...
            <li> <a class="breadcrumb-link active" href="index">Sub Categories</a></li>
          </ul>
        </div>
      </div>
      <!-- End breadcrumb-->
              ...
              <div class="shop-sidebar">
                ...
                <div class="shop-sidebar_department">
                  ...
                  <div class="department_bottom">
                    <ul>
                      <li> <a class="department-link" href="sub-categories">Fresh Meat</a></li>
                      <li> <a class="department-link" href="sub-categories">Vegetables</a></li>
                      <li> <a class="department-link" href="sub-categories">Fruit & Nut Gifts</a></li>
                      <li> <a class="department-link" href="sub-categories">Fresh Berries</a></li>
                      <li> <a class="department-link" href="sub-categories">Ocean Foods</a></li>
                      <li> <a class="department-link" href="sub-categories">Butter & Eggs</a></li>
                      <li> <a class="department-link" href="sub-categories">Fastfood</a></li>
                      <li> <a class="department-link" href="sub-categories">Fresh Onion</a></li>
                      <li> <a class="department-link" href="sub-categories">Papayaya & Crisps</a></li>
                      <li> <a class="department-link" href="sub-categories">Oatmeal</a></li>
                      <li> <a class="department-link" href="sub-categories">Fresh Bananas</a></li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="shop-sidebar_color-filter">
                  ...
                  <div class="color-filter_bottom">
                    <div class="row">
                      <div class="col-6">
                        <div class="color">
                          <div class="visible-color" style="background-color: black;"></div><a href="sub-categories">Black (12)</a>
                        </div>
                        <div class="color">
                          <div class="visible-color" style="background-color: red;"></div><a href="sub-categories">Red (4)</a>
                        </div>
                        <div class="color">
                          <div class="visible-color" style="background-color: orange;"></div><a href="sub-categories">Orange (8)</a>
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="color">
                          <div class="visible-color" style="background-color: blue;"></div><a href="sub-categories">Blue (4)</a>
                        </div>
                        <div class="color">
                          <div class="visible-color" style="background-color: green;"></div><a href="sub-categories">Green (9)</a>
                        </div>
                        <div class="color">
                          <div class="visible-color" style="background-color: pink;"></div><a href="sub-categories">Pink (12)</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="shop-sidebar_tag">
                  ...
                  <div class="tag_bottom">
                      <a class="tag-btn" href="sub-categories">organic</a>
                      <a class="tag-btn" href="sub-categories">vegatable</a>
                      <a class="tag-btn" href="sub-categories">fruits</a>
                      <a class="tag-btn" href="sub-categories">fresh meat</a>
                      <a class="tag-btn" href="sub-categories">fastfood</a>
                      <a class="tag-btn" href="sub-categories">natural</a>
                  </div>
                </div>
              </div>
