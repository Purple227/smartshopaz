...
<head>
    <meta charset="utf-8" />
    <title>Edit Incentive | Smartshoppers Dashboard</title>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Incentive</h4>
...
@endif
                                        ...
                                        <form id="form" enctype="multipart/form-data" method="POST" action=" {{ route('post.rank') }} ">
                                            ...
                                            <div class="form-group">
                                                <label for="to-input">Incentive Name</label>
                                                <input type="text" name="name" class="form-control" id="to-input" placeholder="Name">
                                            </div>

                                            <div class="form-group">
                                                <label for="to-input">Associated Rank</label>
                                                <select>
