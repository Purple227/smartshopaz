...
<head>
    <meta charset="utf-8" />
    <title>Blog Posts | Smartshoppers Dashboard</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control datepicker-here" placeholder="Date" data-min-view="days" data-view="days" data-date-format="dd M yyyy" data-language="en" />
                                            </div>
                                            <div class="form-group">
