...
<head>
    <meta charset="utf-8" />
    <title>Update Subcategories | Smartshoppers Dashboard</title>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Subcategories</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="form">
                                            <div class="form-group">
                                                <label for="to-input">Subcategory Name</label>
                                            ...
                                            <div class="btn-toolbar form-group mb-0">
                                                <div class="">
                                                    <a href="" class="btn btn-primary waves-effect waves-light"> <span>Update</span> <i class="mdi mdi-card-plus-outline ml-1"></i> </a>
                                                </div>
                                            </div>
