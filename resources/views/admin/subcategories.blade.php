...
<head>
    <meta charset="utf-8" />
    <title>Subcategories | Smartshoppers Dashboard</title>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4">
                                <div class="float-right">
                                    <div class="dropdown">
                                        <a href="add-subcat" class="btn btn-dark btn-rounded " type="button">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Subcategories</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group">
                                                            <a href="edit-subcat" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
