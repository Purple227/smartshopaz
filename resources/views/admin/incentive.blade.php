...
<head>
    <meta charset="utf-8" />
    <title>Incentives | Smartshoppers Dashboard</title>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Incentives</h4>
                            ...
                            <div class="col-md-4">
                                <div class="float-right">
                                    <div class="dropdown">
                                        <a href="add-incentive" class="btn btn-dark btn-rounded " type="button">
                                            <i class="mdi mdi-plus mr-1"></i> Add New Incentive
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Incentives</h4>
...
@endif
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    @foreach ($list_incentives as $key => $incentive)
                                                    <td> {{  $key + 1 }} </td>
                                                    <td> {{ $incentive->name }} </td>
                                                    <td><img src="{{ asset('storage/'.$incentive->image) }}" alt="" width="35px"></td>
                                                    <td>
                                                        <div class="btn-group" role="group">

                                                            <a href="{{ route('update.catgory', $incentive->slug) }}" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                <i class="mdi mdi-pencil"></i>
                                                            </a>

                                                            <form id="form" method="GET" action=" {{ route('destroy.incentive', $incentive->id) }} ">
                                                                @csrf
