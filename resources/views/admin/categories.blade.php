...
<head>
    <meta charset="utf-8" />
    <title>Categories | Smartshoppers Dashboard</title>
                                ...
                                <div class="float-right">
                                    <div class="dropdown">
                                        <a href="{{ route('add.catgory') }}" class="btn btn-dark btn-rounded " type="button">
                                            <i class="mdi mdi-plus mr-1"></i> Add New Category
                                        </a>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <form id="form" method="GET" action=" {{ route('destroy.category', $category->id) }} ">
                                                                @csrf
