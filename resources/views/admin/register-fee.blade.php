...
<head>
    <meta charset="utf-8" />
    <title>Registeration fee | Smartshoppers Dashboard</title>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Registeration fee</h4>
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Registeration fee</li>
                                </ol>
                            </div>
                            <!-- <div class="col-md-4">
