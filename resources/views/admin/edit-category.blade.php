...
<head>
    <meta charset="utf-8" />
    <title>Edit Categories | Smartshoppers Dashboard</title>
...
@endif
                                      ...
                                      <form id="form" enctype="multipart/form-data" method="POST" action=" {{ route('patch.category', $category->id) }} ">
                                            @csrf
                                            @method('PATCH')
                                                                                        <div class="form-group">
                                                <label for="to-input">Category Name</label>
                                                <input type="text" name="name" value="{{ $category->name }}" class="form-control" id="to-input" placeholder="Name">
                                            </div>

                                            <div class="form-group">
                                                <h4 class="header-title">Select Icon</h4>
