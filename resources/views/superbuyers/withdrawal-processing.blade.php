...
<head>
    <meta charset="utf-8" />
    <title>Withdrawal Processing | Smartshoppers Dashboard</title>
                ...
                <div class="page-title-box">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-1">Withdrawal Processing</h4>
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Withdrawal Processing</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Withdrawal Processing</h4>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>₦200,000</td>
                                                    <td>
                                                        <a href="order-process"><i class="iconify" data-icon="uim:refresh"></i> Transferred</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
