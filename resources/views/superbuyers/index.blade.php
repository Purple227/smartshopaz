                                ...
                                <div class="col-xl-4">
                                    <div class="card">
                                        ...
                                        <div class="row">
                                                <div class="col-6">
                                                    <h5>Welcome Back !</h5>
                                                    <p class="text-muted">Superbuyers Platform</p>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <p class="text-muted">Number of Downlines</p>
                                                    <h5 class="mb-0">15 <span class="font-size-14 text-muted ml-1">From previous period</span></h5>
                                                </div>
                                    ...
                                    <div class="card text-center">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <h3><sup></sup> 2 <span class="font-size-16">Users</span></h3>
                                                    <div class="mt-1 mb-3">
                                    ...
                                    <div class="card text-center">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <h3><sup></sup> 4 <span class="font-size-16">Users</span></h3>
                                                    <div class="mt-1 mb-3">
                                                        <a href="#" class="btn btn-primary">View Downline</a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card text-center">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <h3><sup></sup> 11 <span class="font-size-16">Users</span></h3>
                                                    <div class="mt-1 mb-3">
                                                        <a href="#" class="btn btn-primary">View Downline</a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card text-center">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <h3><sup></sup> 19 <span class="font-size-16">Users</span></h3>
                                                    <div class="mt-1 mb-3">
                                                        <a href="#" class="btn btn-primary">View Downline</a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card text-center">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <h3><sup></sup> 15 <span class="font-size-16">Users</span></h3>
                                                    <div class="mt-1 mb-3">
                                                        <a href="#" class="btn btn-primary">View Downline</a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card text-center">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <h3><sup></sup> 10 <span class="font-size-16">Users</span></h3>
                                                    <div class="mt-1 mb-3">
                                                        <a href="#" class="btn btn-primary">View Downline</a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card text-center">
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <h3><sup></sup> 8 <span class="font-size-16">Users</span></h3>
                                                    <div class="mt-1 mb-3">
                                                        <a href="#" class="btn btn-primary">View Downline</a>
                                                    </div>
                                                </div>
