...
<head>
    <meta charset="utf-8" />
    <title>Admins | Smartshoppers Dashboard</title>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4">
                                <div class="float-right">
                                    <div class="dropdown">
                                        <a href="add-admin" class="btn btn-dark btn-rounded " type="button">
                                            <i class="mdi mdi-plus mr-1"></i> Add New Admin
                                        </a>
                                    </div>
                                </div>
                            </div>
