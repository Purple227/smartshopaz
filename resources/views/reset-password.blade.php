        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-md-6 mx-auto">
              ...
              <h6 class="text-center"><i class="text-secondary">abc@xyz.com</i>, Type in your new password</h6><br/>
              <form>
                <label for="user-name">New Password*</label>
                <input class="no-round-input" id="password" type="password">
                <label for="user-name">Confirm New Password* <i id='message'></i></label>
                <input class="no-round-input" id="confirm_password" type="password">
                <div class="account-function">
                  <button class="no-round-btn">Submit</button>
                </div>
              </form>
            </div>
          </div>
