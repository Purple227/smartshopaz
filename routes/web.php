...
Route::get('/order-process/{slug}', [OrderController::class, 'showOrder'])->name('super-buyer.order-process')->middleware('super.buyer');
...
Route::get('/checkout', [OrderController::class, 'checkoutUI'])->name('super-buyer.checkout')->middleware('super.buyer');
Route::post('/withdrawal-request', [BankController::class, 'requestWithdrawal'])->name('super-buyer.bank.request');
Route::get('/bank', [BankController::class, 'getrequestWithdrawal'])->name('super-buyer.bank')->middleware('super.buyer');
Route::get('/revenue', [RevenueController::class, 'revenue'])->name('super-buyer.revenue')->middleware('super.buyer');
Route::get('/user-profile', [UserController::class, 'userProfile'])->name('super-buyer.user.profile')->middleware('super.buyer');
});
